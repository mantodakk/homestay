<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand px-4 py-3 m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard "
            target="_blank">
            <img src="<?php echo $rootPath; ?>/assets/img/logo-ct-dark.png" class="navbar-brand-img" width="26"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#accountExamples" class="nav-link text-dark collapsed"
                    aria-controls="accountExamples" role="button" aria-expanded="false">
                    <i
                        class="material-symbols-rounded opacity-5   me-2 ">account_circle</i>
                    <span class="nav-link-text ms-1 ps-1">Tempah</span>
                </a>
                <div class="collapse" id="accountExamples" style="">
                    <ul class="nav ">
                        <li class="nav-item ">
