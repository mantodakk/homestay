    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg bg-white  navbar-transparent position-fixed w-100 top-0 z-index-3 shadow-none py-2 start-0 end-0"
                ...
                <ul class="navbar-nav navbar-nav-hover mx-auto">
                    <li class="nav-item dropdown dropdown-hover mx-2">
                        <a role="button"
                            ...
                            Pages
                            <img src="<?php echo $rootPath; ?>/assets/img/down-arrow-dark.svg" alt="down-arrow"
                                class="arrow ms-1">
                        </a>
                        <div class="dropdown-menu dropdown-menu-animation dropdown-xl p-3 border-radius-lg mt-0 mt-lg-3"
                                ...
                                <div class="col-12 px-4 py-2">
                                    <div class="row">
                                        <div class="col-4 position-relative">
                                            <div
                                                class="dropdown-header text-dark font-weight-bold d-flex justify-content-cente align-items-center px-0">
                                                <div
                                                    class="icon icon-shape icon-xs rounded-circle bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center">
                                                    <i class="ni ni-atom text-white text-xs opacity-10 top-0"></i>
                                                </div>
                                                Landing Pages
                                            </div>
                                            <a href="https://demos.creative-tim.com/now-ui-design-system-pro/pages/coworking.html"
                                            ...
                                            <div
                                                class="dropdown-header text-dark font-weight-bold d-flex align-items-center px-0 mt-3">
                                                <div
                                                    class="icon icon-shape icon-xs rounded-circle bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center">
                                                    <i class="ni ni-building text-white text-xs opacity-10 top-0"></i>
                                                </div>
                                                Company
                                            </div>
                                        ...
                                        <div class="col-4 position-relative">
                                            <div
                                                class="dropdown-header text-dark font-weight-bold d-flex justify-content-cente align-items-center px-0">
                                                <div
                                                    class="icon icon-shape icon-xs rounded-circle border-radius-md bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center ps-0">
                                                    <i class="ni ni-headphones text-white text-xs opacity-10 top-0"></i>
                                                </div>
                                                Support
                                            </div>
                                            ...
                                            <div
                                                class="dropdown-header text-dark font-weight-bold d-flex justify-content-cente align-items-center mt-3 px-0">
                                                <div
                                                    class="icon icon-shape icon-xs rounded-circle border-radius-md bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center ps-0">
                                                    <i class="ni ni-box-2 text-white text-xs opacity-10 top-0"></i>
                                                </div>
                                                Apps
                                            </div>
                                        ...
                                        <div class="col-4">
                                            <div
                                                ...
                                                <div
                                                    class="icon icon-shape icon-xs rounded-circle border-radius-md bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center ps-0">
                                                    <i class="ni ni-planet text-white text-xs opacity-10 top-0"></i>
                                                </div>
                                                Blogs
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="icon icon-shape icon-xs rounded-circle border-radius-md bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center ps-0">
                                                    <i class="ni ni-sound-wave text-white text-xs opacity-10 top-0"></i>
                                                </div>
                                                Extra
                                            </div>
                                            ...
                                            <a href="javascript:;" class="dropdown-item">
                                                <span class="ps-3">VR <span
                                                        class="badge badge-sm bg-secondary rounded-pill ms-1">Soon</span></span>
                                            </a>
                                            <a href="javascript:;" class="dropdown-item">
                            ...
                            <div class="d-lg-none">
                                ...
                                <div
                                    class="dropdown-header text-dark font-weight-bold d-flex justify-content-cente align-items-center px-0 mt-3">
                                    <div
                                        class="icon icon-shape icon-xs rounded-circle bg-gradient-primary text-center me-2 d-flex align-items-center justify-content-center">
                                        <i class="ni ni-building text-white text-xs opacity-10 top-0"></i>
                                    </div>
                                ...
                                <a href="javascript:;" class="dropdown-item border-radius-md">
                                    <span class="ps-3">VR</span> <span
                                        class="badge badge-sm bg-secondary ms-1">Soon</span>
                                </a>
                                <a href="javascript:;" class="dropdown-item border-radius-md">
                                    <span class="ps-3">Smart Home</span> <span
                                        class="badge badge-sm bg-secondary ms-1">Soon</span>
                                </a>
                            </div>
                        </div>
                    ...
                    <li class="nav-item dropdown dropdown-hover mx-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-lg py-0 mt-0 mt-lg-3 pe-3"
                            aria-labelledby="dropdownMenuAccount">
                            <div class="row d-none d-lg-flex">
                                <div class="col-6">
                                    <div class="py-6 h-100 w-100 d-flex border-radius-lg border-radius-top-end-0 border-radius-bottom-end-0 position-relative dropdown-image"
                                        style="background-image:url('<?php echo $rootPath; ?>/assets/img/bg3.jpg')">
                                        <div
                                            class="mask bg-gradient-primary border-radius-lg border-radius-top-end-0 border-radius-bottom-end-0">
                                        </div>
                                        <div
                                            ...
                                            <div class="icon icon-shape text-center">
                                                <i class="ni ni-atom text-white h4 opacity-10" aria-hidden="true"></i>
                                            </div>
                                    ...
                                    <ul class="list-group">
                                        <li
                                            ...
                                            <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between mb-1"
                                                id="dropdownSignIn">
                                                <span>Sign In</span>
                                                <img src="<?php echo $rootPath; ?>/assets/img/down-arrow.svg"
                        ...
                        <div class="dropdown-menu dropdown-menu-animation dropdown-lg dropdown-lg-responsive p-3 border-radius-lg mt-0 mt-lg-3"
                                ...
                                <ul class="list-group">
                                    <li
                                        ...
                                        <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="https://demos.creative-tim.com/now-ui-design-system-pro/sections/page-sections/hero-sections.html">
                                                Page Headers
                                            </a>
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                            ...
                            <div class="row d-lg-none">
                                <div class="col-md-12">
                                    ...
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="https://demos.creative-tim.com/now-ui-design-system-pro/sections/page-sections/hero-sections.html">
                                        <span class="ps-3">Page Header</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/features.html">
                                        <span class="ps-3">Features</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/pricing.html">
                                        <span class="ps-3">Pricing</span>
                                    ...
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/testimonials.html">
                                        <span class="ps-3">Testimonials</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/teams.html">
                                    ...
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/stats.html">
                                        <span class="ps-3">Stats</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/call-to-actions.html">
                                        <span class="ps-3">Call to Actions</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/applications.html">
                                        <span class="ps-3">Applications</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/logo-areas.html">
                                        <span class="ps-3">Logo Areas</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/footers.html">
                                        <span class="ps-3">Footers</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/general-cards.html">
                                        <span class="ps-3">General Cards</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/page-sections/content-sections.html">
                                        <span class="ps-3">Content Sections</span>
                                    </a>
                                    ...
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/navigation/navbars.html">
                                        <span class="ps-3">Navbars</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/navigation/nav-tabs.html">
                                        <span class="ps-3">Nav Tabs</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/navigation/pagination.html">
                                        <span class="ps-3">Pagination</span>
                                    </a>
                                    <div class="d-flex mb-2 mt-3">
                                        <div class="icon h-10 me-3 d-flex mt-1">
                                            <i class="ni ni-badge text-gradient text-primary"></i>
                                    ...
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/input-areas/newsletters.html">
                                        <span class="ps-3">Newsletter</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/input-areas/contact-sections.html">
                                        <span class="ps-3">Contact Sections</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/input-areas/inputs.html">
                                        <span class="ps-3">Inputs</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/input-areas/forms.html">
                                        <span class="ps-3">Forms</span>
                                    </a>
                                    <div class="d-flex mb-2 mt-3">
                                        <div class="icon h-10 me-3 d-flex mt-1">
                                            <i class="ni ni-notification-70 text-gradient text-primary"></i>
                                    ...
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/attention-catchers/modals.html">
                                        <span class="ps-3">Modals</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/attention-catchers/tooltips-popovers.html">
                                        <span class="ps-3">Tooltips & Popovers</span>
                                    </a>
                                    <div class="d-flex mb-2 mt-3">
                                        <div class="icon h-10 me-3 d-flex mt-1">
                                            <i class="ni ni-app text-gradient text-primary"></i>
                                    ...
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/avatars.html">
                                        <span class="ps-3">Avatars</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/badges.html">
                                        <span class="ps-3">Badges</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/breadcrumbs.html">
                                        <span class="ps-3">Breadcrumbs</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/buttons.html">
                                        <span class="ps-3">Buttons</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/button-groups.html">
                                        <span class="ps-3">Button Groups</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/dropdowns.html">
                                        <span class="ps-3">Dropdowns</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/progress-bars.html">
                                        <span class="ps-3"></span>Progress Bars
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/social-buttons.html">
                                        <span class="ps-3">Social Buttons</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/tables.html">
                                        <span class="ps-3">Tables</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/toggles.html">
                                        <span class="ps-3">Toggles</span>
                                    </a>
                                    <a class="dropdown-item ps-3 border-radius-md mb-1"
                                        href="sections/elements/typography.html">
                                        <span class="ps-3">Typography</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul class="list-group">
                                    <li class="nav-item list-group-item border-0 p-0">
                                        <a class="dropdown-item py-2 ps-3 border-radius-md"
                                            href=" https://www.creative-tim.com/learning-lab/bootstrap/overview/now-ui-design-system ">
                                            <div class="d-flex">
                                                <div class="icon h-10 me-3 d-flex mt-1">
                                    ...
                                    <li class="nav-item list-group-item border-0 p-0">
                                        <a class="dropdown-item py-2 ps-3 border-radius-md"
                                            href=" https://www.creative-tim.com/learning-lab/bootstrap/colors/now-ui-design-system ">
                                            <div class="d-flex">
                                                <div class="icon h-10 me-3 d-flex mt-1">
                                    ...
                                    <li class="nav-item list-group-item border-0 p-0">
                                        <a class="dropdown-item py-2 ps-3 border-radius-md"
                                            href=" https://www.creative-tim.com/learning-lab/bootstrap/alerts/now-ui-design-system ">
                                            <div class="d-flex">
                                                <div class="icon h-10 me-3 d-flex mt-1">
                                    ...
                                    <li class="nav-item list-group-item border-0 p-0">
                                        <a class="dropdown-item py-2 ps-3 border-radius-md"
                                            href=" https://www.creative-tim.com/learning-lab/bootstrap/datepicker/now-ui-design-system ">
                                            <div class="d-flex">
                                                <div class="icon h-10 me-3 d-flex mt-1">
                                    ...
                                    <li class="nav-item list-group-item border-0 p-0">
                                        <a class="dropdown-item py-2 ps-3 border-radius-md"
                                            href=" https://www.creative-tim.com/learning-lab/bootstrap/utilities/now-ui-design-system ">
                                            <div class="d-flex">
                                                <div class="icon h-10 me-3 d-flex mt-1">
                                                    <i class="ni ni-support-16 text-secondary"></i>
                                                </div>
                                                <div>
                                                    <h6
                                                        class="dropdown-header text-dark font-weight-bold d-flex justify-content-cente align-items-center p-0">
                ...
                <ul class="navbar-nav d-lg-block d-none">
                    <li class="nav-item">
                        <a href="javascript:;" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1"
                            onclick="smoothToPricing('pricing-now-ui')">Buy Now</a>
                    </li>
                </ul>
            </div>
        </div>
