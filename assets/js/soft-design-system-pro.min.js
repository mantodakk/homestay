...
total.forEach(function (n, e) {
  ...
  if (
    ...
    for (i = 1; i < r; i++)
      a += n.querySelector("li:nth-child(" + i + ")").offsetWidth;
    ...
    total.forEach(function (l, e) {
      ...
      if (n) {
        ...
        if (l.classList.contains("flex-column")) {
          for (var s = 1; s <= e.indexOf(n); s++)
            t += l.querySelector("li:nth-child(" + s + ")").offsetHeight;
          ...
          for (s = 1; s <= e.indexOf(n); s++)
            t += l.querySelector("li:nth-child(" + s + ")").offsetWidth;
