...
var FullCalendar = (function (e) {
  ...
  function b(e, t, n, r, i) {
    ...
    e: if ("style" === t)
      ...
      (s = t !== (t = t.replace(/Capture$/, ""))),
        ...
        (e.l[t + s] = n),
        n
          ? r || e.addEventListener(t, s ? E : S, s)
          : e.removeEventListener(t, s ? E : S, s);
  ...
  function _(e, t, n) {
    for (var r, i = e.__k, s = 0; i && s < i.length; s++)
      (r = i[s]) &&
        ((r.__ = e),
        (t =
          "function" == typeof r.type ? _(r, t, n) : M(n, r, r, i, r.__e, t)));
    return t;
  }
  function k(e, t) {
    return (
      ...
      e: if ("function" == typeof _) {
        if (
          ...
          if (
            ...
            (!u.__e &&
              ...
              !1 === u.shouldComponentUpdate(b, u.__s, E)) ||
              t.__v === r.__v)
          ) {
            for (
              t.__v !== r.__v &&
        ...
        (u.state = u.__s),
          ...
          h ||
            ...
            (m = u.getSnapshotBeforeUpdate(p, g)),
          (x =
            null != d && d.type === v && null == d.key ? d.props.children : d),
  ...
  (n.__b = function (e) {
    ...
    (n.diffed = function (e) {
      ...
      t &&
        t.__H &&
        (t.__H.__h.length &&
          ((1 !== G.push(t) && U === n.requestAnimationFrame) ||
            ((U = n.requestAnimationFrame) || J)(X)),
  ...
  class on {
    constructor(e) {
      ...
      for (let i in e)
        i in Jt
          ? ((n[i] = e[i]), (r = Math.max(Jt[i], r)))
          : ((t[i] = e[i]), i in Kt && (r = Math.max(Kt[i], r)));
              ...
              (function (e, t, n, r, i) {
                ...
                !1 === r.meridiem
                  ...
                  : "lowercase" === r.meridiem &&
                    (e = e.replace(en, (e) => e.toLocaleLowerCase()));
  ...
  function Qn(e, t, n, r, i, s, o, l, a, c, d, u, h) {
    return {
      ...
      createScrollResponder: (e) =>
        new qn(e, c, ht(n.scrollTime), n.scrollTimeReset),
  ...
  class Zn extends C {
    shouldComponentUpdate(e, t) {
      return (
        ...
        !On(this.props, e, this.propEquality) ||
          !On(this.state, t, this.stateEquality)
      );
    }
    safeSetState(e) {
      On(
  ...
  function gr(e, t = ht(0)) {
    ...
    return (
      e.start && ((n = Nt(e.start)), r && r <= n && (r = xt(n, 1))),
      { start: n, end: r }
    );
  }
  function mr(e) {
  ...
  class br {
    ...
    buildRangeFromDuration(e, t, n, r) {
      ...
      return (
        vt(n) <= 1 &&
          this.isHiddenDay(i) &&
          ((i = this.skipHiddenDays(i, t)), (i = Nt(i))),
        c(),
  ...
  function Tr(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Wr), Rr),
  ...
  function Fr(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Wr), Ur),
  ...
  function ti(e, t, n) {
    ...
    return (
      e
        ? ((s = Nt(s)), (s = r.add(s, i.defaultAllDayEventDuration)))
  ...
  function ii(e, t, n, r, i) {
    ...
    return (
      ...
      t.allDay &&
        (a.range = { start: Nt(a.range.start), end: Nt(a.range.end) }),
      a.range.end < a.range.start &&
        (a.range.end = ti(t.allDay, a.range.start, i)),
      a
    );
  }
  class si {
  ...
  class oi {
    ...
    setProp(e, t) {
      if (e in Dr)
        ...
        (t = wr[e](t)), this.mutate({ standardProps: { publicId: t } });
      else if (e in wr)
        (t = wr[e](t)), this.mutate({ standardProps: { [e]: t } });
      else if (e in Wr) {
        let n = Wr[e](t);
        (n =
          "color" === e
    ...
    get source() {
      ...
      return e
        ? new si(this._context, this._context.getCurrentData().eventSources[e])
        : null;
    }
    get start() {
  ...
  class ji {
    ...
    select(e, t) {
      ...
      i &&
        (this.dispatch({ type: "SELECT_DATES", selection: i }), Kr(i, null, r));
    }
    unselect(e) {
      let t = this.getCurrentData();
      t.dateSelection &&
    ...
    addEvent(e, t) {
      if (e instanceof oi) {
        ...
        return (
          this.getCurrentData().eventStore.defs[t.defId] ||
            (this.dispatch({
              type: "ADD_EVENTS",
              eventStore: Mr({ def: t, instance: n }),
            }),
      ...
      if (i) {
        ...
        return (
          this.dispatch({ type: "ADD_EVENTS", eventStore: Mr(i) }),
          this.triggerEventAdd(e),
          e
        );
      }
  ...
  function es(e, t, n = "day", r = !0) {
    ...
    if (s.navLinks) {
      ...
      return Object.assign(
        { title: ot(s.navLinkHint, [l, e], l), "data-navlink": "" },
        r ? Ve(a) : { onClick: a }
      );
    }
    return { "aria-label": l };
  ...
  class ms {
    ...
    handleInvalidInsertion(e, t, n) {
      if (this.allowReslicing && e.touchingEntry) {
        const r = Object.assign(Object.assign({}, t), {
          span: Ss(t.span, e.touchingEntry.span),
        });
    ...
    insertEntryAt(e, t) {
      ...
      -1 === t.lateral
        ? (Es(r, t.level, t.levelCoord), Es(n, t.level, [e]))
        : Es(n[t.level], t.lateral, e),
  ...
  class Os extends C {
    ...
    computeTiming() {
      ...
      return (
        (s = Math.min(864e5, s)),
        {
          currentState: { nowDate: r, todayRange: Ns(r) },
          nextState: { nowDate: i, todayRange: Ns(i) },
          waitMs: s,
        }
      );
    }
  ...
  class js {
    ...
    _sliceBusinessHours(e, t, n, r, ...i) {
      return e
        ? this._sliceEventStore(Er(e, Ls(t, Boolean(n)), r), {}, t, n, ...i).bg
        : [];
    }
          ...
          for (let r in a) {
            ...
            for (let e of g.allows) {
              let i,
                ...
                l = b.defs[m.defId],
                a = b.instances[r];
              if (((i = l ? new oi(t, l, a) : new oi(t, m)), !e(ei(s, t), i)))
                return !1;
            }
          }
          return !0;
  ...
  class Xs extends Xn {
    ...
    getXScrollbarWidth() {
      return Zs.test(this.props.overflowX)
        ? 0
        : this.el.offsetHeight - this.el.clientHeight;
    }
    getYScrollbarWidth() {
      return Zs.test(this.props.overflowY)
        ? 0
  ...
  class ho extends Xn {
    ...
    render() {
      ...
      for (; c < a && "header" === (l = r[c]).type; )
        d.push(this.renderSection(l, s, !0)), (c += 1);
      for (; c < a && "body" === (l = r[c]).type; )
        u.push(this.renderSection(l, s, !1)), (c += 1);
      for (; c < a && "footer" === (l = r[c]).type; )
        h.push(this.renderSection(l, s, !0)), (c += 1);
      let f = !Ni();
        ...
        (e, t) =>
          g(
            ...
            Boolean(t.isEndResizable) &&
              g("div", { className: "fc-event-resizer fc-event-resizer-end" })
          )
      );
    }
  }
      ...
      return g(
        ...
        Object.assign({}, e, {
          ...
          elAttrs: Object.assign(
            ...
            r.isDisabled ? {} : { "data-date": Ft(e.date) }
          ),
          renderProps: r,
      ...
      return g(
        ...
        (t, r, i) =>
          g(
            ...
            bo(e) &&
              g(t, { elTag: "div", elClasses: ["fc-more-popover-misc"] }),
            n.children
          )
      );
    }
  ...
  function Yo(e) {
    ...
    return (
      t.content
        ? (n = Qo(t))
        : !n ||
          n.prototype instanceof Xn ||
          (n = Qo(Object.assign(Object.assign({}, t), { content: n }))),
      ...
      (e) =>
        (function (e, t, n, r, i) {
          ...
          if (
            ...
            let e = Ct(o);
            (l = e.unit),
              1 === e.value && ((a = l), (c = t[l] ? t[l].rawOptions : {}));
          }
          let d = (t) => {
              let n = t.buttonText || {},
  ...
  function Jo(e, t, n, r) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return nl(
          e,
          t.sourceIds ? Tn(t.sourceIds) : il(e, r),
          i,
          t.isRefetch || !1,
          r
        );
  ...
  class yl {
    ...
    _handleAction(e) {
      ...
      this.data &&
        ...
        ("PREV" !== e.type && "NEXT" !== e.type && fr(d.currentRange, c)) ||
      ...
      if (l && l !== a) {
        l.timeZone !== a.timeZone &&
          ...
          (t.eventStore = s.eventStore =
            Qr(s.eventStore, n.dateEnv, s.dateEnv)),
          (t.renderableEventStore = s.renderableEventStore =
            Qr(s.renderableEventStore, n.dateEnv, s.dateEnv)));
        for (let e in o)
          (-1 === this.optionsForHandling.indexOf(e) && l[e] === a[e]) ||
            o[e](a[e], s);
      }
    ...
    processRawCalendarOptions(e, t) {
      let { locales: n, locale: r } = En([pn, e, t]),
        ...
        a = (this.currentCalendarOptionsRefiners = Object.assign(
          Object.assign(
            Object.assign(Object.assign(Object.assign({}, fn), gn), mn),
            l.listenerRefiners
          ),
          l.optionRefiners
        )),
      ...
      for (let e in d)
        ...
        (d[e] === h[e] || (vn[e] && e in h && vn[e](h[e], d[e])))
          ? (u[e] = f[e])
          : a[e]
          ? ((u[e] = a[e](d[e])), (p = !0))
          : (c[e] = h[e]);
      ...
      for (let e in s)
        s[e] === a[e] || (vn[e] && vn[e](s[e], a[e]))
          ...
          : (s[e] === this.currentCalendarOptionsInput[e] ||
            (vn[e] && vn[e](s[e], this.currentCalendarOptionsInput[e]))
              ? e in this.currentCalendarOptionsRefined &&
                (l[e] = this.currentCalendarOptionsRefined[e])
              : o[e]
              ? (l[e] = o[e](s[e]))
              : (u[e] = s[e]),
            (d = !0));
    ...
    renderWidgetGroup(e) {
      ...
      for (let s of e) {
        ...
        if ("title" === e)
          (i = !1),
            r.push(
              g("h2", { className: "fc-toolbar-title", id: t.titleId }, t.title)
            );
        else {
  ...
  class Nl extends Zn {
    ...
    render() {
      ...
      return g(
        ...
        g(
          Ml,
          { liquid: s, height: o, aspectRatio: e, labeledById: a },
          this.renderView(t),
  ...
  function Wl(e) {
    ...
    return new zn(
      Object.assign(
        Object.assign({ timeZone: pn.timeZone, calendarSystem: "gregory" }, e),
        { locale: t }
      )
    );
  }
  ...
  class Gl {
    ...
    cleanup() {
      this.mirrorEl && (ke(this.mirrorEl), (this.mirrorEl = null)),
        (this.sourceEl = null);
    }
    updateElPosition() {
      this.sourceEl &&
    ...
    handleMove(e, t) {
      if (this.isEnabled) {
        ...
        i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
          ...
          this.isAnimating ||
            ((this.isAnimating = !0), this.requestAnimation(Yl()));
      }
    }
    stop() {
      if (this.isEnabled) {
  ...
  class Xl {
    ...
    isWithinClipping(e, t) {
      ...
      for (let e of this.scrollCaches)
        if (!$l(e.getEventTarget()) && !Li(n, e.clientRect)) return !1;
      return !0;
    }
  }
  function $l(e) {
  ...
  class Jl {
    ...
    handleMove(e, t) {
      ...
      (!t && Kl(this.movingHit, n)) ||
        ((this.movingHit = n), this.emitter.trigger("hitupdate", n, !1, e));
    }
    prepareHits() {
      this.offsetTrackers = xn(
        this.droppableStore,
        (e) => (e.component.prepareHits(), new Xl(e.el))
      );
    }
    releaseHits() {
  ...
  function Kl(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && xi(e.dateSpan, t.dateSpan))
    );
  }
  function ea(e, t) {
    let n = {};
        ...
        (this.handleHitUpdate = (e, t, n) => {
          ...
          e &&
            ...
            this.canDropElOnCalendar(n.subjectEl, i) &&
              ...
              o &&
                ((l.mutatedEvents = { defs: {}, instances: {} }), (s = null)))),
      ...
      class extends Hi {
        constructor(e) {
          super(e),
            ...
            (this.handlePointerUp = (e) => {
              this.dragSelection &&
                (Kr(this.dragSelection, e, this.component.context),
                (this.dragSelection = null));
            });
          let { component: t } = e,
            { options: n } = t.context,
          ...
          super(e),
            ...
            (this.handleHitUpdate = (e, t, n) => {
              ...
              l &&
                ...
                (d.mutatedEvents = a),
                zs(d, e.dateProfile, r) ||
                  ((c = !0), (l = null), (a = null), (d.mutatedEvents = null))),
                a
  ...
  function wa(e, t, n, r, i, s, o) {
    ...
    for (let t = 0; t < e.length; t += 1) {
      let n = e[t],
        r = Ca(n);
      null != i[r]
        ? a.push({ index: t, span: { start: n.firstCol, end: n.lastCol + 1 } })
        : c.push(n);
    }
    let d = l.addSegs(a),
      u = l.toRects(),
        ...
        for (let o of e) {
          ...
          s.push(
            g(
              ...
              "bg-event" === t
                ? g(Eo, Object.assign({ seg: o }, Ei(o, r)))
                : wo(t)
            )
          );
        }
      ...
      if (this.needsScrollReset && this.props.clientWidth) {
        const e = (function (e, t) {
          ...
          t.currentRangeUnit.match(/year|month/) &&
            (n = e.querySelector(`[data-date="${Vt(t.currentDate)}-01"]`));
  ...
  function Ba(e) {
    ...
    return g(Yn.Consumer, null, (n) => {
      if (!e.isLabeled)
        return g("td", { className: t.join(" "), "data-time": e.isoTimeStr });
  ...
  class La extends Xn {
    render() {
      return this.props.slatMetas.map((e) =>
        g("tr", { key: e.key }, g(Ba, Object.assign({}, e)))
      );
    }
  }
      ...
      super(...arguments),
        ...
        (this.renderHeadAxis = (e, t = "") => {
          let { options: n } = this.context,
            ...
            i = r.renderRange,
            s =
              1 === kt(i.start, i.end) ? es(this.context, i.start, "week") : {};
          ...
          h.push({
            ...
            outerContent: g(
              ...
              g("td", {
                colSpan: 2,
                className:
                  "fc-timegrid-divider " + a.theme.getClass("tableCellShaded"),
              })
            ),
          }));
  ...
  class Fa {
    ...
    computeDateTop(e, t) {
      return (
        t || (t = Nt(e)), this.computeTimeTop(ht(e.valueOf() - t.valueOf()))
      );
    }
    computeTimeTop(e) {
      let t,
              ...
              let s = Ja(
                  (function (e, t, n) {
                    ...
                    for (; a < l; a += 1) {
                      ...
                      if (r < o)
                        return { level: a, lateralStart: r, lateralEnd: o };
                    }
                    return null;
                  })(e, r, i),
                  n
  ...
  class sc extends Xn {
    ...
    renderFillSegs(e, t) {
      let { props: n, context: r } = this,
        i = nc(e, n.date, n.slatCoords, r.options.eventMinHeight).map(
          (r, i) => {
            let s = e[i];
            return g(
              "div",
              ...
              "bg-event" === t
                ? g(
                    Eo,
                    Object.assign({ seg: s }, Ei(s, n.todayRange, n.nowDate))
                  )
                : wo(t)
            );
          }
    ...
    computeSegHStyle(e) {
      ...
      return (
        s && !e.stackForward && (a[r ? "marginLeft" : "marginRight"] = 20), a
      );
    }
  }
  function oc(
  ...
  class cc extends gs {
    ...
    queryHit(e, t) {
      let { dateEnv: n, options: r } = this.context,
        ...
        { snapDuration: l, snapsPerSlot: a } = this.processSlotOptions(
      ...
      a =
        ...
        (function (e) {
          ...
          for (t = pc.length - 1; t >= 0; t -= 1)
            if (((n = ht(pc[t])), (r = Et(n, e)), null !== r && r > 1))
              return n;
          return e;
        })(r),
      c = [];
        ...
        component: class extends gs {
          ...
          renderEmptyMessage() {
            ...
            return g(
              ...
              (e) =>
                g(e, { elTag: "div", elClasses: ["fc-list-empty-cushion"] })
            );
          }
          renderSegList(e, t) {
              ...
              for (let n = 0; n < l.length; n += 1) {
                ...
                if (d) {
                  let l = Ft(t[n]),
                    u = o + "-" + l;
                  c.push(
                    g(yc, { key: l, cellId: u, dayDate: t[n], todayRange: a })
                  ),
                    (d = gi(d, r.eventOrder));
                  for (let t of d)
                    c.push(
  ...
  var Wc = zo({
    ...
    viewContainerAppends: [
      function (e) {
        let t = 'CC-Attribution-NonCommercial-NoDerivatives',
  ...
  class Uc {
    ...
    queryElGeoms(e) {
      ...
      for (let t of e) {
        ...
        "start" === l
          ? (l = n ? "right" : "left")
          : "end" === l && (l = n ? "left" : "right"),
          "sticky" !== o.position &&
            (a = Ui(
              s,
              -r.left - (parseFloat(o.left) || 0),
              -r.top - (parseFloat(o.top) || 0)
            )),
          i.push({
            parentBound: e,
            naturalBound: a,
    ...
    render() {
      ...
      return (
        ...
        "scroll-hidden" === a &&
          ...
          (r ? (i = t.yScrollbarWidth) : (s = t.yScrollbarWidth)),
        g(
          "div",
          {
            ref: this.elRef,
            ...
            Xs,
            {
              ...
              maxHeight:
                "number" == typeof e.maxHeight
                  ? e.maxHeight +
                    ("scroll-hidden" === l ? t.xScrollbarWidth : 0)
                  : "",
              liquid: e.liquid,
              liquidIsAbsolute: !0,
            },
    ...
    bindScroller(e) {
      ...
      return (
        r.emitter.on("scroll", (r, i) => {
          if (
            !this.isPaused &&
            ((!this.masterEl || (this.masterEl !== e && (r || i))) &&
              this.assignMaster(e),
            this.masterEl === e)
          )
            for (let r of t)
  ...
  class Yc extends Xn {
    constructor() {
      super(...arguments),
        ...
        (this.handleSizing = (e, t) => {
          ...
          let n = {};
          (e || (!t && !this.rowUnstableMap.size)) &&
            (n.sectionRowMaxHeights = this.computeSectionRowMaxHeights()),
            this.setState(
              Object.assign(
                Object.assign(
        ...
        (this.handleRowHeightChange = (e, t) => {
          ...
          if (t) {
            ...
            let t = Zc(e);
            (r.has(e) && r.get(e) === t) ||
              (r.set(e, t), (this.anyRowHeightsChanged = !0)),
              !n.size &&
      ...
      return g(
        ...
        (function (e, t) {
          let n = e.map((e, n) => {
            let r = e.width;
            return (
              "shrink" === r && (r = e.totalColWidth + io(t[n]) + 1),
              g("col", { style: { width: r } })
            );
          });
          return g("colgroup", {}, ...n);
    ...
    renderSection(e, t, n, r, i, s) {
      return "outerContent" in e
        ...
        : g(
            ...
            e.chunks.map((o, l) =>
              this.renderChunk(e, t, n[l], r[l], o, l, (i[t] || [])[l] || [], s)
            )
          );
    }
    ...
    allowSizing() {
      ...
      return !this.lastSizingDate ||
        e.valueOf() >
          this.lastSizingDate.valueOf() + Ds.SCROLLGRID_RESIZE_INTERVAL
    ...
    computeSectionRowMaxHeights() {
      ...
      for (let i = 0; i < t; i += 1) {
        ...
        if (t && t.syncRowHeights) {
          ...
          for (let e = 1; e < n; e += 1) {
            if (
              !(t.chunks[e] && void 0 !== t.chunks[e].outerContent) &&
              r[e].length !== o
            ) {
              l = !1;
              break;
      ...
      for (let s = 0; s < t; s += 1)
        for (let t = 0; t < n; t += 1) {
          ...
          if (h) {
            let n = h.parentNode;
            (c[u] = Math.floor(
              n.getBoundingClientRect().width - (t === r && l ? e.y : 0)
            )),
              (d[u] = Math.floor(
                n.getBoundingClientRect().height - (s === i && a ? e.x : 0)
              ));
          }
        }
      return {
  ...
  function cd(e) {
    ...
    (!e.classList.contains("fc-scrollgrid-collapsible") ||
      t < Ds.COLLAPSIBLE_WIDTH_THRESHOLD) &&
      (e.style.width = t + "px");
  }
  function dd(e) {
    e.style.width = "";
  ...
  var ud = zo({
    ...
    contextInit: function (e) {
      sd.length ||
        (window.addEventListener("beforeprint", ld),
        window.addEventListener("afterprint", ad)),
        sd.push(e),
        e.calendarApi.on("_unmount", () => {
          wt(sd, e),
            sd.length ||
              (window.removeEventListener("beforeprint", ld),
  ...
  function fd(e, t, n, r) {
    ...
    (i.largeUnit = l),
      (i.emphasizeWeeks =
        1 === pt(i.slotDuration) && vd("weeks", e, t) >= 2 && !n.businessHours);
    let a,
      c,
      d = n.snapDuration;
    ...
    i.isTimeScale &&
      ((h = t.add(h, e.slotMinTime)), (f = t.add(xt(f, -1), e.slotMaxTime))),
      (i.timeWindowMs = u),
    ...
    const y = [],
      b = [];
    for (g = h; g < f; )
      gd(g, i, e, r) ? ((m += 1), y.push(m), b.push(v)) : y.push(m + 0.5),
  ...
  function pd(e, t, n) {
    ...
    return (
      t.isTimeScale ||
        ((r = Nt(r)), t.largeUnit && (r = n.startOf(r, t.largeUnit))),
      r
    );
  }
  function gd(e, t, n, r) {
  ...
  class Dd {
    ...
    dateToCoord(e) {
      ...
      return this.isRtl
        ? o.originClientRect.width - (o.rights[r] - s.getWidth(r) * i)
        : o.lefts[r] + s.getWidth(r) * i;
    }
    rangeToCoords(e) {
  ...
  class Td extends Xn {
    ...
    render() {
      let { props: e, context: t } = this,
        ...
        r =
          e.slatCoords && e.slatCoords.dateProfile === e.dateProfile
            ? e.slatCoords
            : null;
  ...
  class _d extends Xn {
    render() {
      let { props: e, context: t } = this,
        ...
        c = Object.assign(Object.assign({ date: n.toDate(e.date) }, a), {
          view: t.viewApi,
        });
      return g(
        rr,
      ...
      let { todayRange: r, nowDate: i } = this.props,
        ...
        l = e.map((e, t) => {
          ...
          return g(
            ...
            "bg-event" === n
              ? g(Eo, Object.assign({ seg: e }, Ei(e, r, i)))
              : wo(n)
          );
        });
      return g(v, null, l);
      ...
      if (Rd(s.start, r, i) < Rd(s.end, r, i)) {
        ...
        e &&
          o.push({
            ...
            isStart:
              e.start.valueOf() === s.start.valueOf() && gd(e.start, r, t, n),
            isEnd:
              e.end.valueOf() === s.end.valueOf() && gd(Tt(e.end, -1), r, t, n),
          });
      }
      return o;
    }
  ...
  class Bd extends Xn {
    ...
    render() {
      let { props: e, state: t, context: n } = this,
        ...
        l =
          (o.eventDrag ? o.eventDrag.segs : null) ||
          (o.eventResize ? o.eventResize.segs : null) ||
          [],
        ...
        [d, u] = (function (e, t, n, r, i, s) {
          ...
          for (let r = 0; r < e.length; r += 1) {
            let i = e[r],
              ...
              a = t[r];
            s && a
              ? o.push({ index: r, span: a, thickness: s })
              : l.push({ seg: i, hcoords: a, top: null });
          }
          let a = new ms();
            ...
            (function (e, t, n) {
              ...
              let r = (function (e) {
                ...
                for (let n of e) {
                  let { seg: e } = n;
                  Array.isArray(e) ||
                    (t[e.eventRange.instance.instanceId] = n.top);
                }
                return t;
              })(n);
              return e.map((e) => ({
          ...
          this.setState(
            {
              ...
              moreLinkHeights: xn(this.moreElRefs.currentMap, (e) =>
                Math.round(e.getBoundingClientRect().height)
              ),
            },
            () => {
        ...
        component: class extends gs {
          ...
          render() {
            let { props: e, state: t, context: n } = this,
              ...
              i = !e.forPrint && co(r),
              s = !e.forPrint && uo(r),
              o = this.buildTimelineDateProfile(
                e.dateProfile,
                n.dateEnv,
                r,
                n.dateProfileGenerator
            ...
            return (
              s &&
                c.push({
                  ...
                  key: "footer",
                  isSticky: !0,
                  chunks: [{ key: "timeline", content: ao }],
                }),
              g(
                sr,
                {
                  elClasses: [
                    "fc-timeline",
                    !1 === r.eventOverlap ? "fc-timeline-overlap-disabled" : "",
                  ],
                  viewSpec: n.viewSpec,
                },
                g(Yc, {
  ...
  function Gd(e, t = "", n, r) {
    ...
    if (
      (Object.freeze(o.ui.classNames), Object.freeze(o.extendedProps), n[o.id])
    );
    else if (((n[o.id] = o), i.children))
      for (let e of i.children) Gd(e, o.id, n, r);
    return o;
  }
  function Fd(e) {
  ...
  class Kd extends Xn {
    ...
    renderResourceRow(e, t) {
      let n = e.map((e) =>
        g(Jd, { key: e.id, resource: e, colSpan: 1, date: t })
      );
    ...
    renderResourceAndDayRows(e, t, n, r) {
      ...
      for (let o of e) {
        i.push(
          g(Jd, { key: o.id, resource: o, colSpan: t.length, isSticky: !0 })
        );
    ...
    buildTr(e, t) {
      ...
      return (
        e.length || (e = [g("td", { key: 0 }, " ")]),
        g("tr", { key: t, role: "row" }, n && n(t), e)
      );
    }
  }
  function eu(e, t, n) {
  ...
  class ou {
    ...
    expandSegs(e, t) {
      let n = e.resources.length,
        r = [];
      for (let i = 0; i < n; i += 1)
        for (let n of t) r.push(...this.transformSeg(n, e, i));
      return r;
    }
    joinInteractions(e, ...t) {
      ...
      for (let l = 0; l < n; l += 1) {
        ...
        if (t[n])
          for (let r of t[n].segs) i.push(...this.transformSeg(r, e, l));
      }
          ...
          if (d)
            if (r) {
              ...
              let t = d.spec.field + ":" + d.value,
                a = null != o[t] ? o[t] : l;
              n.push({ id: t, group: d, isExpanded: a }),
    ...
    if (n.length && (-1 === i || r <= i)) {
      du(
        ...
        (function (e, t, n) {
          ...
          r ||
            ((r = { group: { value: s, spec: n }, children: [] }),
            t.splice(i, 0, r));
          return r;
        })(e, t, n[0]).children,
        n.slice(1),
  ...
  function hu(e) {
    let t = Object.assign(
      Object.assign(Object.assign({}, e.extendedProps), e.ui),
      e
    );
  ...
  function fu(e, t) {
    ...
    if (null == n) {
      ...
      r && (n = r.extendedProps.resourceEditable),
        null == n &&
          ((n = t.options.eventResourceEditable),
  ...
  function wu(e, t, n) {
    ...
    if (!e || !t)
      return Du(
        r.initialResources || r.resources,
        i.activeRange,
        r.refetchResourcesOnNavigate,
        n
      );
    switch (t.type) {
  ...
  function Au(e, t, n, r) {
    ...
    switch (t.type) {
      ...
      case "ADD_RESOURCE":
        return (
          (i = e), (s = t.resourceHash), Object.assign(Object.assign({}, i), s)
        );
      case "REMOVE_RESOURCE":
        return (function (e, t) {
          ...
          for (let e in n)
            n[e].parentId === t &&
              (n[e] = Object.assign(Object.assign({}, n[e]), { parentId: "" }));
          return n;
        })(e, t.resourceId);
      case "SET_RESOURCE_PROP":
        return (function (e, t, n, r) {
          ...
          if (i)
            return Object.assign(Object.assign({}, e), {
              [t]: Object.assign(Object.assign({}, i), { [n]: r }),
            });
          return e;
    ...
    isDraggableTransformers: [
      function (e, t, n, r) {
        if (!e) {
          ...
          if (
            e.viewSpecs[e.currentViewType].optionDefaults.needsResourceData &&
            fu(t, r)
          )
            return !0;
        }
    ...
    eventDragMutationMassagers: [
      function (e, t, n) {
        ...
        r &&
          i &&
          r !== i &&
          (e.resourceMutation = { matchResourceId: r, setResourceId: i });
      },
    ],
    eventDefMutationAppliers: [
      function (e, t, n) {
        ...
        if (
          (e &&
            ...
            (r = Object.assign(Object.assign({}, r), {
              ...
              eventUiBases: Object.assign(
                Object.assign({}, n[""].eventUiBases),
                r.eventUiBases
              ),
            })),
  ...
  class Pu extends gs {
    ...
    render() {
      ...
      let o = xn(this.slicers, (e, o) =>
        e.sliceProps(s[o], i, r, t, n.dayTableModel)
      );
      return g(
        _a,
        Object.assign(
        ...
        component: class extends la {
          ...
          render() {
            let { props: e, context: t } = this,
              ...
              s = this.buildResourceDayTableModel(
                e.dateProfile,
                t.dateProfileGenerator,
                i,
                n.datesAboveResources,
                t
              ),
              o =
                n.dayHeaders &&
  ...
  class Bu extends ou {
    transformSeg(e, t, n) {
      return [
        Object.assign(Object.assign({}, e), { col: t.computeCol(e.col, n) }),
      ];
    }
  }
  class ju extends gs {
        ...
        component: class extends Ua {
          ...
          render() {
            let { props: e, context: t } = this,
              ...
              a = this.buildResourceTimeColsModel(
                i,
                t.dateProfileGenerator,
                l,
                n.datesAboveResources,
        ...
        g(
          "span",
          {
            className:
              ...
              (t ? "" : " fc-datagrid-expander-placeholder"),
            onClick: r,
          },
      ...
      super(...arguments),
        ...
        (this.handleHeightChange = (e, t) => {
          this.props.onHeightChange &&
            this.props.onHeightChange(Me(e, "tr"), t);
        });
    }
    render() {
      let { props: e, context: t } = this,
    ...
    updateCoords() {
      ...
      e.onRowCoords &&
        ...
        this.props.onRowCoords(
          new ds(
            this.rootElRef.current,
            ((t = this.rowElRefs.currentMap), e.rowNodes.map((e) => t[e.id])),
            !1,
            !0
          )
        );
  ...
  class nh extends gs {
    ...
    render() {
      let { props: e, state: t, context: n } = this,
        ...
        d =
          t.slatCoords && t.slatCoords.dateProfile === e.dateProfile
            ? t.slatCoords
            : null;
      return g(
        "div",
  ...
  class ih extends Xn {
    ...
    render() {
      ...
      let l =
        null != t.resourceAreaWidthOverride
          ? t.resourceAreaWidthOverride
          : r.resourceAreaWidth;
      return g(Yc, {
        ref: this.scrollGridRef,
        elRef: this.rootElRef,
        ...
        collapsibleWidth: !1,
        colGroups: [
          { cols: e.spreadsheetCols, width: l },
          { cols: [] },
          { cols: e.timeCols },
        ],
        sections: o,
    ...
    initSpreadsheetResizing() {
      ...
      if (n) {
        let t,
          ...
          o = (this.spreadsheetResizerDragging = new n(
            s,
            ".fc-resource-timeline-divider"
          ));
  ...
  class sh extends Xn {
    ...
    render() {
      let { props: e, state: t, context: n } = this,
        ...
        d = this.buildTimelineDateProfile(
          e.dateProfile,
          n.dateEnv,
          r,
          n.dateProfileGenerator
      ...
      return g(
        ...
        g(ih, {
          ...
          spreadsheetBodyRows: (e) =>
            g(v, null, this.renderSpreadsheetRows(u, c, e.rowSyncHeights)),
          timeCols: f,
          timeHeaderContent: (n) =>
            g(Td, {
              clientWidth: n.clientWidth,
    ...
    (e.Draggable = class {
      constructor(e, t = {}) {
        (this.handlePointerDown = (e) => {
          ...
          (t.minDistance =
            null != n ? n : e.isTouch ? 0 : pn.eventDragMinDistance),
